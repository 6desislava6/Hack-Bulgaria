...
class Test_Network(unittest.TestCase):
    ...
    def test_add_panda(self):
        self.assertTrue(hash(self.ivo) in self.network.pandas.keys())
        self.assertEqual(len(self.network.pandas[hash(self.ivo)]), 0)
    ...
    def test_make_friends(self):
        ...
        self.assertTrue(
            self.rado in self.network.pandas[hash(self.ivo)])
